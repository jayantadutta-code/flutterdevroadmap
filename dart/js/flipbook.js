/* ==========================================================================
   Dart 3D FlipBook Engine - Multi-Sheet 3D Physics & Navigation Engine
   ========================================================================== */
...
class FlipBookEngine {
  constructor() {
    ...
    this.searchDatabase = [
      ...
      { id: 1, title: "1.1 Introduction to Dart", sheet: 2, moduleIdx: 0, exp: "Dart origins, client optimization, JIT & AOT compilation.", keywords: ["intro", "introduction", "dart", "jit", "aot"] },
  ...
  bindEvents() {
    ...
    const tocCloseBtn = document.getElementById('closeTocModalBtn');
